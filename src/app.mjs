...
export const createApp = (service) => {
  ...
  app.post('/access-performance-capacity-reviews', (request, response, next) => {
    try {
  ...
  app.get('/access-performance-capacity-reviews/:id', (request, response, next) => {
    try {
  ...
  app.post('/access-performance-capacity-reviews/:id/:action', (request, response, next) => {
    try {
